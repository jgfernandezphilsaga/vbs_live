<?php 
	...
	//$pmcConnectionInfo = array( "Database"=>"PMC-WFS", "UID"=>"sa", "PWD"=>"philsaga");
	$vbsConnectionInfo = array( "Database"=>"PMC-WFS", "UID"=>"apps_wfs", "PWD"=>"Phahd2fe");
	// $vbsConnectionInfo = array( "Database"=>"wfs-mark", "UID"=>"sa", "PWD"=>"M@st3radm1n12345" );
	$vbs_connect = array( "Database"=>"vbs_db", "UID"=>"app_vbs", "PWD"=>"o1W!V~{<" );
