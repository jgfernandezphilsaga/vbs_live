                                    ...
                                    <li>
                                        <div class="form-check">
                                            <input class="form-check-input"
                                                ...
                                                name="statuses[]"
                                                value="{{ $status->id }}"
                                                id="checkbox-{{ $status_name }}"
                                                {{ in_array($status->id, $checkedStatuses) ? 'checked' : '' }}>
                                            <label class="form-check-label filter-status-btn-label"
                                                style="font-size: 13px;"
                                                for="checkbox-{{ $status_name }}">
                                                {{ $status->status }}
                                            </label>
                                        </div>
                                    </li>
                        ...
                        <tbody>
                            @foreach($request_headers as $header)
                                <tr>
                                    ...
                                    <td style="text-align:center">
                                       @if($header->status == 1012)
                                            <span class="badge status-draft m-0" style="width: 100%"> DRAFT </span> <!-- UPDATE CSS -->
                                    ...
                                    <td style="text-align: center" id="actions">
                                        ...
                                        @if(null !== session('user_role'))
                                            @if(
                                                (session('user_role') == 'dept_secretary' && ($header->status == '1012' || $header->status == '5' || $header->status == '1009'))
                                            )
                                                <a  class="btn btn-warning" href="{{ route('edit.request', ['id' => $header->id]) }}" data-bs-toggle="tooltip" title="Edit this item"><i class="fa-solid fa-pen-to-square" style="color:white"></i></a>
                                            @else                                            
