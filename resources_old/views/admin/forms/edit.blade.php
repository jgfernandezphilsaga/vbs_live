                        ...
                        <tbody id="table-body">
                            @for($i = 0; $i < count($details); $i++)
                                <tr class="data-row" data-row-id="{{ $i }}">
                                    ...
                                    <td>
                                        <input type="datetime-local" id="start_datetime"class="form-control form-input" name="start_datetime[]" value="{{ $details[$i]->departure_time }}" style="width:100%; font-size:13px;" {{ $readonly }}/>
                                    </td>
                                     <td>
                                        ...
                                        <input type="hidden" class="form-control" name="requested_hrs[]" value="{{ $details[$i]->requested_hrs }}" style="width:100%; font-size:13px;" {{ $readonly }}/>
                                    <td>
                                    ...
                                    <td>
                                        <select class="form-select form-input trip-select {{ !$isOwner ? 'readonly-select2' : '' }}" 
                                        name="trip_type[]" style="font-size: 13px;" {{ $readonly }}>
                                    ...
                                    <td>
                                        <select class="form-control emp-select2 {{ !$isOwner ? 'readonly-select2' : '' }}" id="passengers-{{ $i }}" name="passengers[{{ $i }}][]" multiple true  style="width: 100%" {{ $readonly }}>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    updateBtn.addEventListener('click', function(event){
        ...
        $.ajax({
            url: '{{env('APP_URL')}}/request/update/{{ $header->id }}',
            method : 'POST',
            data: requestData,
            processData: false,
            contentType: false,
