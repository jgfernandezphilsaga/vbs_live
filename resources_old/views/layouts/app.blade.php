...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <link href="{{ asset('VBS/public/css/forms/forms.css') }}" rel="stylesheet">
        <link href="{{ asset('VBS/public/css/select2.min.css') }}" rel="stylesheet" />
        <link href="{{ asset('VBS/public/css/forms/forms.css') }}" rel="stylesheet">
        ...
        <link href="{{ asset('VBS/public/css/modal/modal.css') }}" rel="stylesheet"> <!-- Modal CSS -->
        ...
        <!-- Select2 -->
        <link href="{{ asset('VBS/public/assets/select2/dist/css/select2.min.css') }}" rel="stylesheet">
        ...
        <style>
            @font-face {
                font-family: 'Poppins';
                src:
                    url('/VBS/public/assets/fonts/poppins/Poppins-Regular.ttf') format('truetype');
                font-weight: normal;
                font-style: normal;
            }
    ...
    <!-- Bootstrap Scripts -->
    <script src="{{ asset('VBS/public/assets/bootstrap-5.3.3-dist/js/bootstrap.bundle.min.js') }}"></script>

    <!-- Canvas -->
    <!-- <script src="{{ asset('VBS/public/canvass/js/jquery.js') }}" > </script>
    <script src="{{ asset('VBS/public/canvass/js/plugins.min.js') }}" > </script> -->
    ...
    <!-- Moment JS -->
    <script src="{{ asset('VBS/public/assets/momentjs/moment.js') }}" ></script>
