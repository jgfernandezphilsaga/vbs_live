    ...
    <div class="row">
        <div class="col-md-12">
                    ...
                    <div class="d-flex justify-content-end">
                        <button class="btn btn-primary me-2 d-flex align-items-center d-none" id="assign-btn" type="submit">
                    ...
                    $('#assign-btn').on('click', function () {
                        ...
                        response.data.forEach(function(item) {
                            if (item.passengers) {
                                ...
                                passengers.forEach(function(passenger) {
                                    ...
                                    if (empId && empName) {
                                        let cleanId = empId.replace('EMPID-', '');
                        ...
                        let selectHtml = `
                            <form id="dispatchForm" method="POST" action="{{ route('dispatch.save_dispatch') }}">
                                ...
                                <div class="mb-3">
                                    <label for="vehicleSelect" class="form-label">Purpose</label>
                                ...
                                <div class="d-flex justify-content-end">
                                    ...
                                    <span id="submit-btn-text" class="ms-2">Dispatch</span>
                                </button>
                                </div>
                            </form>
...
$(document).on('click', '#dispatch-btn', function(e) {
    ...
    complete: function() {
        ...
        $submitBtn.prop('disabled', false).html('<i class="fa fa-paper-plane"></i> <span class="ms-2">Dispatch</span>');
